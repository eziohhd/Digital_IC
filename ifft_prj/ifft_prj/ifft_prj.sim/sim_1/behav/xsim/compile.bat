...
REM
REM Generated by Vivado on Sat Mar 30 23:18:00 +0800 2024
...
echo "xvlog --incr --relax -prj tb_ifft64_radix2_top_vlog.prj"
call xvlog  --incr --relax -prj tb_ifft64_radix2_top_vlog.prj -log xvlog.log
